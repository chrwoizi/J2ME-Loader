...
public class Config {
	...
	public static final String EMULATOR_DIR = Environment.getExternalStorageDirectory() + "/chaos-campus";
	public static final String SCREENSHOTS_DIR =
			Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/chaos-campus";
